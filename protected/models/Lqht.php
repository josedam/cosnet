...
/**
 * This is the model class for table "lqht".
 *
 * The followings are the available columns in table 'lqht':
 ...
 */
class Lqht extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Lqht the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
            ...
            'concepto' => array(self::BELONGS_TO, 'lqcpto', 'cpto'),
	...
	{
	  return $this->pen_hon + $this->pen_gto;
	}
	
	public function getLiq()
	{
	  return $this->liq_hon+$this->liq_gto;
	}
	
	public function getAju()
	{
	  return $this->aju_debe - $this->aju_haber;
	}
	
	public function getXAjuste()
	{
	  if($this->debe>0){
	    $s='CR';
	  } else {
	...
	public function detalleSocio($lq, $csoc)
	{
