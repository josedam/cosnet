...
/**
 * This is the model class for table "lqrecip".
 *
 * The followings are the available columns in table 'lqrecip':
 ...
 */
class Lqrecip extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Lqrecip the static model class
	 */
